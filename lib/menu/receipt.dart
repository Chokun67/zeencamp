...
class Receipt extends StatelessWidget {
  ...
  TextStyle stylewhite(heightsize) => TextStyle(color: const Color(0xFFFFFFFF), fontSize: heightsize * 0.025,fontWeight: FontWeight.w500);
  @override
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Container(
                  padding: EdgeInsets.only(left: widthsize*0.06,top: widthsize*0.06,right: widthsize*0.06),
                  child: Column(
  ...
  Widget titleReceipt(widthsize, heightsize) => Container(
        padding: EdgeInsets.only(left: 0.06 * widthsize, top: 0.05 * widthsize),
          ...
          children: [
            Container(
              ...
              child: Row(
                  ...
                  children: [Text("จากบัญชี",style: stylewhite(heightsize),), Text("zeenbootcamp",style: stylewhite(heightsize),)]),
            ),
            Container(
              padding: EdgeInsets.all(widthsize * 0.04),
              child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [Text("ไปยัง",style: stylewhite(heightsize),), Text("zeenbootcamp",style: stylewhite(heightsize),)]),
            ),
            Container(
              width: widthsize * 0.78,
              margin: EdgeInsets.only(top: widthsize*0.04,bottom: widthsize*0.04),
              decoration: const BoxDecoration(
                border: Border(
            ...
            Container(
              ...
              child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [Text("จำนวนเงิน",style: stylewhite(heightsize),), Text("zeenbootcamp",style: stylewhite(heightsize),)]),
            )
          ],
        ),
      );
